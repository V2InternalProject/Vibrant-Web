...
namespace LineGraphTest
{
	...
	public class Line2D
	{
		...
		public void InitializeGraph()
		{
			...
			//Drawing Y-Axis line.
			objGraphics.DrawLine(new Pen(new SolidBrush(Color.Black),2),100,Height - 100,100,100);
		...
		private void SetAxisText(ref Graphics objGraphics)
		{
			...
			{
				objGraphics.DrawString(YAxisText[iIndex].ToString(),new Font("Verdana",10,FontStyle.Bold),new SolidBrush(Color.Black),
					X,Y);
				Y += 10;
			}
