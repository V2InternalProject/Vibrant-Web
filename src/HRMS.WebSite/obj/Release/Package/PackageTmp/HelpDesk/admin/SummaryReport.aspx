<%@ Page Language="c#" CodeBehind="SummaryReport.aspx.cs" AutoEventWireup="True"
    Inherits="V2.Helpdesk.web.admin.SummaryReport" MasterPageFile="~/Views/Shared/HRMS.Master" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <script language="javascript">
        $(document).ready(function () {
            $("#SummaryReportTab").removeClass('tabshover').addClass('colored-border');
        });
    ...
    <section class="HelpdeskContainer Container">
        ...
        <div class="MainBody summary_report">
            <div class="TabsContainer">
                <RT:ReportsTabs ID="ReportsTabs1" runat="server"></RT:ReportsTabs>
                <section class="clearfix SummaryReport add-detailsdata">
                    ...
                    <asp:CompareValidator ID="CmpDate" runat="server" Visible="True" ControlToValidate="txtToDate"
                        ...
                        Operator="GreaterThanEqual" Type="Date" Display="None">
                    ...
                    <asp:DataGrid ID="dgSummaryReport" CssClass="TableJqgrid mrgnT20" runat="server"
                        AutoGenerateColumns="True" CellPadding="5" AllowPaging="True" Width="100%" PageSize="10"
                        ItemStyle-VerticalAlign="Top" ItemStyle-HorizontalAlign="Left" AlternatingItemStyle-VerticalAlign="Top"
                    ...
                    <asp:ValidationSummary ID="ValidationSummary1" runat="server" ShowMessageBox="True"
                        ValidationGroup="submit" ShowSummary="False"></asp:ValidationSummary>
                </section>
            </div>
        </div>
    </section>
