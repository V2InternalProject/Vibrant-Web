...
//Helper functions
	...
	createModal : function(aIDs, content, p, insertSelector, posSelector, appendsel, css) {
		...
		if(p.resize) {
			if($.fn.jqResize) {
		$(mw).append("<div style='height:30px;'></div>");
	...
	info_dialog : function(caption, content,c_b, modalopt) {
		...
		cnt += "<div id='infocnt' style='margin:0px;padding-bottom:1em;width:100%;overflow:auto;position:relative;height:"+dh+";text-align:left;'>"+content+"</div>";
		cnt += c_b ? "<div class='ui-widget-content ui-helper-clearfix BorderNone' style='text-align:"+mopt.buttonalign+";padding-bottom:0.8em;padding-top:0.5em;background-image: none;border-width: 1px 0 0 0;'><a href='javascript:void(0)' id='closedialog' class='fm-button ui-state-default ui-corner-all'>"+c_b+"</a>"+buttstr+"</div>" :
			buttstr !== ""  ? "<div class='ui-widget-content ui-helper-clearfix' style='text-align:"+mopt.buttoalign+";padding-bottom:0.8em;padding-top:0.5em;background-image: none;border-width: 1px 0 0 0;'>"+buttstr+"</div>" : "";
		cnt += "</div>";
		...
		if (editable==="1") {
			...
			if (cv[0] === false){
				try {
                    ...
                    $.jgrid.info_dialog($.jgrid.errors.errcap,cv[1],$.jgrid.edit.bClose,{left:900,top:200});
				} catch (e) {
					alert(cv[1]);
				}
				return success;
