$("#AppraisalShowStatusTable").jqGrid({
    // Ajax related configurations
    url: 'ShowStatusDetails/Appraisal',
    datatype: "json",
    mtype: "POST",
    postData: { AppraisalID: function () { return $('#appraisalIdToPassOnLinkClick').val() } },
    ...
    bottompager: false,
    // Paging
    pager: $("#ShowStatusAppraisalTablePager"),
    rowNum: 10,
    rowList: [10, 20, 40],
...
}).navGrid("#ShowStatusAppraisalTablePager",
