...
function AdminSendMail() {
    ...
    if (counter == 1) {
        ...
        var Parameter = { employeeId: EmpIdToPassAdmin }
        $.ajax({
            url: MailUrl,
            type: 'GET',
            cache: false,
            data: { "employeeId": EmpIdToPassAdmin, "collection": collection },
                        ...
                        if ($('#MailDetails').valid()) {
                            ...
                            $.ajax({
                                ...
                                success: function (data) {
                                    ...
                                    //$('#btnADMINSendPendingItem').dialog('destroy');
