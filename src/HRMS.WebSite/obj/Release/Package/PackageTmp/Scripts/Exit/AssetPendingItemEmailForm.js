...
function AssetSendMail() {
    ...
    if (counter == 1) {
        ...
        var Parameter = { employeeId: EmpIdToPassAsset }
        $.ajax({
            url: MailUrl,
            type: 'GET',
            cache: false,
            data: { "employeeId": EmpIdToPassAsset, "collection": collection },
                        ...
                        if ($('#MailDetails').valid()) {
                            ...
                            $.ajax({
                                ...
                                success: function (data) {
                                    ...
                                    //$('#btnAssetSendPendingItem').dialog('destroy');
