$("#ConfirmationShowStatusTableNew").jqGrid({
    // Ajax related configurations
    url: 'ShowStatusDetailsConfirmation/ConfirmationProcess',
    datatype: "json",
    mtype: "POST",
    ...
    pager: $("#ShowStatusConfirmationTablePager"),
    rowNum: 10,
    rowList: [10, 20, 40],
...
}).navGrid("#ShowStatusConfirmationTablePager",
