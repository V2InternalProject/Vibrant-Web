...
{
    public partial class ConfigItems : System.Web.UI.Page
    {
        private ConfigItemBOL objConfigItemBOL = new ConfigItemBOL();
        private ConfigItemModel objConfigItemModel = new ConfigItemModel();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                ViewState["AdminMaster"] = "ConfigSetting";
                if (!IsPostBack)
                {
                    bindData();
                }
        ...
        protected void grdConfigItem_ItemCommand(object source, DataGridCommandEventArgs e)
        {
            try
            {
                ...
                #endregion Commented code for Add
        ...
        private bool CheckIfNumberic(string myNumber)
        {
            try
            {
                bool IsNum = true;
