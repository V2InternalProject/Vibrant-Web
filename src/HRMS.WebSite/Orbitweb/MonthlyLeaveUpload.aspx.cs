...
{
    public partial class MonthlyLeaveUpload : System.Web.UI.Page
    {
        private MonthlyLeaveUploadModel objMonthlyLeaveUploadModel = new MonthlyLeaveUploadModel();
        private MonthlyLeaveUploadBOL objMonthlyLeaveUploadBOL = new MonthlyLeaveUploadBOL();
        private DataSet dsMonthlyLeaveUpload = new DataSet();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                lblError.Text = "";
                lblSuccess.Text = "";
                ViewState["AdminMaster"] = "MonthlyUpload";
                if (!IsPostBack)
                {
                    BindYear();
                    BindData();
        ...
        #endregion AddNewMonthlyLeaveDetails
        ...
        #endregion UpdateNewMonthlyLeaveDetails
