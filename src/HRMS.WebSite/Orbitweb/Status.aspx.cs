...
namespace HRMS.Orbitweb
{
    ...
    {
        private StatusMasterModel objStatusMasterModel = new StatusMasterModel();
        private StatusMasterBOL objStatusMasterBOL = new StatusMasterBOL();
