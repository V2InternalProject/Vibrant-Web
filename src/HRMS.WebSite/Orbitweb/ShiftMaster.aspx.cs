...
namespace HRMS.Orbitweb
{
    ...
    {
        private ShiftMasterBOL objShiftMasterBOL = new ShiftMasterBOL();
        private ShiftMasterModel objShiftMasterModel = new ShiftMasterModel();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ViewState["AdminMaster"] = "ShiftMaster";
                if (!Page.IsPostBack)
                {
                    BindData();
                }
