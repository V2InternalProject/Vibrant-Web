<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ConfigItems.ascx.cs"
    Inherits="HRMS.Orbitweb.ConfigItems1" %>
...
<asp:UpdatePanel ID="UpdatePanel1" UpdateMode="Conditional" runat="server">
    <ContentTemplate>
        ...
        <div>
            <asp:DataGrid ID="grdConfigItem" runat="server" PageSize="10" OnEditCommand="grdConfigItem_EditCommand"
                ...
                CssClass="TableJqgrid" Width="100%">
                ...
                <Columns>
                    ...
                    <asp:TemplateColumn HeaderText="ConfigItem Value" ItemStyle-Width="32%">
                        ...
                        <EditItemTemplate>
                            <asp:TextBox ID="txtConfigItemValue1" MaxLength="100" runat="server" Height="28px" Width="100px"
                                Text='<%# DataBinder.Eval(Container.DataItem, "ConfigItemValue") %>'>
                            </asp:TextBox>
                            ...
                            <asp:ImageButton ImageUrl="~/images/New Design/calender-icon.png" Visible="false" runat="server"
                    ...
                    <asp:TemplateColumn HeaderText="ConfigItem Description" ItemStyle-Width="27%">
                        ...
                        <EditItemTemplate>
                            <asp:TextBox ID="txtConfigItemDescription1" TextMode="MultiLine" runat="server"
                                Text='<%# DataBinder.Eval(Container.DataItem, "ConfigItemDescription") %>'>
                            </asp:TextBox>
                        </EditItemTemplate>
                    </asp:TemplateColumn>
