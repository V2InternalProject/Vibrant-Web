<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ShiftMaster.ascx.cs"
    Inherits="HRMS.Orbitweb.ShiftMaster" %>
    ...
    <ContentTemplate>
        ...
        <div>
            <asp:DataGrid ID="grdShiftMaster" runat="server" ShowFooter="True" PageSize="1000"
                AutoGenerateColumns="False" AllowPaging="True" Width="100%" OnItemCommand="grdShiftMaster_ItemCommand"
