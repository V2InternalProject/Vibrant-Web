<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="OutOfOffice.aspx.cs" Inherits="OutOfOffice"
    Title="Out Of Office" %>
    ...
    <section class="LeaveMgmtContainer Container">
        <div class="FixedHeader">
            ...
            <nav class="sub-menu-colored">
                <!-- <a href="ExpenseIndex.html">Leave Application</a>
							<a href="SubmittedR.html" class="selected">Compensatory Leave Application</a> -->
            </nav>
        </div>
            ...
            <tr>
                <td>
                    ...
                    <table width="100%" class="tableBorder">
                        <tr>
                            <td colspan="8" class="h10" style="height: 10px" width="100">
                            </td>
                        </tr>
                        <tr>
                            <td style="width: 5%">
