<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="LeaveApplicationForm.aspx.cs"
    Inherits="LeaveApplicationForm" Title="Leave Application Form" %>
        ...
        <%--<asp:HiddenField--%>
            <div class="clearfix">
                ...
                <p class="leave-note">
                    ...
                    <span class="SpanNote">*Only pending entries will be editable.</span>
                </p>
            ...
            <div class="tabs">
                <ul class="leave-mgmt-tabs">
                    <li id="tab1">
                        <asp:LinkButton ID="lnkAddLeavess" OnClick="lnkAddLeaves_Click" runat="server" Text="Add Details"
                    ...
                    <li id="tab2">
                        <asp:LinkButton ID="lnkSearchs" OnClick="lnkSearch_Click" runat="server" Text="Search Details"
                            CausesValidation="false"></asp:LinkButton></li>
                    <li id="tab3">
                        <asp:LinkButton ID="lnkHolidayLists" runat="server" Text="Holiday List" CausesValidation="false"
                            OnClientClick="return false;"></asp:LinkButton></li>
                </ul>
                <%--<form id="form1" runat="server">
            ...
            <section class="add-detailsdata" id="addDetails">
                <asp:Panel ID="PanelAddDetails" runat="server">
                    <div class="fill-dtls">
                        <label for="From Date">
                            From Date:</label>
                        <asp:TextBox ID="txtFromDate" runat="server" ReadOnly="false" placeholder="From Date"></asp:TextBox>
                        ...
                        <label for="To Date">
                            To Date:</label>
                        <asp:TextBox ID="txtToDate" TabIndex="1" runat="server" ReadOnly="false" placeholder="To Date"></asp:TextBox>
                    ...
                    <div class="fill-dtls1">
                        <label for="Reason" class="lb-reason">
                            Reason:</label>
                        <asp:TextBox ID="txtReason" TabIndex="2" runat="server" TextMode="MultiLine" CssClass="reason"></asp:TextBox>
                ...
                <asp:Panel ID="PanelSearchDetails" runat="server">
                    <div class="fill-dtls clearfix">
                        ...
                        <div class="remain">
                            <label for="From Date">
                                From Date:</label>
                            <asp:TextBox ID="txtSearchFromDate" TabIndex="1" runat="server" ReadOnly="false"
                                placeholder="From Date"></asp:TextBox>
                            <asp:ImageButton ID="imgbtnSearchFromDate" runat="server" CausesValidation="false"
                                ImageUrl="images/New Design/calender-icon.png" ImageAlign="Middle" CssClass="ui-datepicker-trigger">
                            </asp:ImageButton>
                            ...
                            <label for="To Date">
                                To Date:</label>
                            <asp:TextBox ID="txtSearchToDate" TabIndex="2" runat="server" ReadOnly="false" placeholder="To Date"></asp:TextBox>
            ...
            <td align="center">
                <table id="tdSearch" class="tableBorder" width="100%" runat="server">
                    <tbody>
                        ...
                        <tr>
                            <td style="height: 10px" class="h10" colspan="8">
                            </td>
                        </tr>
                    </tbody>
                </table>
